...
public class register {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		month.click();
		WebElement option2 = driver.findElement(By.xpath("//*[@id=\"month\"]/option[5]"));
		option2.click();
		...
		//WebElement logOutMsg = driver .findElement(By.linkText("Log Out"));
		

		driver.findElement(By.className("_2s25 _cy7")).click();
